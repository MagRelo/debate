      ...
      {!data || !data.length ?
        ...
        <ResponsiveContainer>
          <AreaChart data={data} margin={{ top: 28, right: 0, left: 0, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="tokenBuyPrice" stroke="#12ca01" fillOpacity={1} fill="url(#colorBuy)" />
            <Area type="monotone" dataKey="tokenSellPrice" stroke="#fcd036" fillOpacity={1} fill="url(#colorSell)" />
